...
public class OrderServiceSpringTest {
    ...
    @Test
    void createOrder() {
        var order = orderService.createOrder("0100", BigDecimal.ONE); // variable
    ...
    @Test
    void createDupOrders() {
        List<OrderReq> orderReqs= List.of(new OrderReq("0300", BigDecimal.ONE), new OrderReq("0300", BigDecimal.TWO));
